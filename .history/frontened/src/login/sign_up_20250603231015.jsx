        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-2/5 bg-gradient-to-br from-indigo-600 to-purple-700 p-8 md:p-12 flex flex-col justify-between">
            ...
            <div className="mt-8 grid grid-cols-3 gap-4">
              {[...Array(6)].map((_, i) => (
                <div key={i} className="bg-white/10 backdrop-blur-sm rounded-lg p-3 flex items-center justify-center">
          ...
          <div className="w-full md:w-3/5 p-8 md:p-12">
            ...
            <form className="space-y-6">
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-gray-700 text-sm font-medium mb-2" htmlFor="fitness">
                    Fitness Goal
                  </label>
                  <div className="relative">
                    <select
                      id="fitness"
                      className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all appearance-none"
                    >
            ...
            <div className="mt-8">
              ...
              <div className="mt-6 grid grid-cols-3 gap-3">
                <button className="flex items-center justify-center py-2 px-4 border border-gray-300 rounded-xl shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
