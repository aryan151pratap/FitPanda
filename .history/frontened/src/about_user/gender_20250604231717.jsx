			...
			<div className="w-full sm:max-w-xl md:max-w-3xl">
				<div className="bg-white rounded-2xl shadow-xl overflow-hidden p-8">
					...
					<div className="flex flex-col justify-between">
						...
						{gen.map((i, index) => (
							<div key={index}>
								<button className="w-full p-2 text-white text-2xl rounded-sm rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 cursor-pointer transition hover:px-4">
									{i}
								</button>
							</div>
						))}
