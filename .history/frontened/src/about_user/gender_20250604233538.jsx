...
function Gender(){
  ...
  <ellipse cx="200" cy="120" rx="12" ry="8" fill="black"/> <!-- Nose -->
  <path d="M180 140 Q200 155 220 140" stroke="black" stroke-width="2" fill="none"/> <!-- Smile -->
  
  <path d="M160 75 L180 75" stroke="white" stroke-width="3"/> <!-- Left eyelid (masculine) -->
  <path d="M220 75 Q225 70 230 75" stroke="#FF69B4" stroke-width="3" fill="none"/> <!-- Right eyelid (feminine) -->
  ...
  <rect x="105" y="285" width="10" height="5" rx="2" fill="#FF69B4"/> <!-- Masculine hand polish -->
  <rect x="285" y="285" width="10" height="5" rx="2" fill="#5BCEFA"/> <!-- Feminine hand polish -->
  ...
  <path d="M150 460 L170 460" stroke="#5BCEFA" stroke-width="3"/> <!-- Sneaker stripe -->
  <circle cx="245" cy="460" r="8" fill="#FF69B4"/> <!-- Ballet shoe detail -->
  
  <rect x="170" y="180" width="60" height="170" fill="#F5F5F5" stroke="black" stroke-width="1"/>
  <path d="M170 180 Q200 150 230 180" fill="#5BCEFA"/> <!-- Left shoulder - blue -->
  <path d="M230 180 Q200 150 170 180" fill="#FF69B4"/> <!-- Right shoulder - pink -->
  ...
  <rect x="120" y="400" width="160" height="20" fill="#5BCEFA"/> <!-- Light Blue -->
  <rect x="120" y="420" width="160" height="20" fill="#F5A9B8"/> <!-- Light Pink -->
  <rect x="120" y="440" width="160" height="20" fill="white"/> <!-- White -->
</svg>
						</div>
					</div>
