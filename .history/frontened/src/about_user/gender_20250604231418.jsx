			...
			<div className="w-full sm:max-w-xl md:max-w-3xl">
				<div className="bg-white rounded-2xl shadow-xl overflow-hidden p-8">
					<div className="text-center mb-8">
						<div className="mx-auto flex items-center justify-center w-16 h-16 bg-indigo-100 rounded-full mb-10">
						{gender === "male" ?
						...
						<p className="text-gray-500 mt-2">
							select your gender
							<span className="block font-medium text-indigo-600 mb-5"></span>
						</p>
					</div>
					...
					<div className="flex flex-col justify-between">
						...
						{gen.map((i, index) => (
							<div key={index}>
								<button className="text-white rounded-l-sm rounded-r-full p-2 bg-gradient-to-br from-indigo-500 to-purple-500 cursor-pointer transition hover:px-4">
									{i}
								</button>
							</div>
						))}
