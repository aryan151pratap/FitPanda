...
function Details(){
	const [data, setData] = useState({ weight: '', height: '', age: ''})
	return(
		<>
		<div>
			...
			{[
				{ label: 'Height (cm)', placeholder: 'Enter your height' },
				{ label: 'Weight (kg)', placeholder: 'Enter your weight' },
				{ label: 'Age (years)', placeholder: 'Enter your age' },
			].map((field, index) => (
