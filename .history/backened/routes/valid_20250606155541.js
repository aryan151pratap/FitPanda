...
const handle_send_mail = async function(email, user, res){  
...
router.post('/sign_up', async (req, res) => {
  ...
  try {
    ...
    if (existingUser) {		
      ...
      handle_send_mail(email, existingUser, res);
    ...
    handle_send_mail(email, user, res);
...
router.post('/login', auth, async (req, res) => {
  ...
  try {
    ...
    if (existingUser) {		
      if(existingUser.verified && bcrypt.compareSync(password, existingUser.password)){
        handle_cookies(existingUser);
      }
